...
export const Header = () => {
  return (
    <header className="sticky top-0 z-10 bg-ui shadow-[0_1px_2px_var(--gray-6)] md:gap-6 lg:gap-8">
      <div className="wrapper flex h-20 items-center justify-between gap-4">
        <Link
